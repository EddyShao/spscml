...
if image_name == "vlasov_sheath":
    sheath_tesseract_api = vlasov_sheath_tesseract_api
    print("Using Vlasov sheath model")
elif image_name == "tanh_sheath":
    sheath_tesseract_api = tanh_sheath_tesseract_api
...
# with Tesseract.from_url("http://127.0.0.1:63076") as sheath_tx:
